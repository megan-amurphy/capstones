...
-- Insert transfers for user_id 1001
INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount)
VALUES
(2, 1, (SELECT account_id FROM account WHERE user_id = 1001), (SELECT account_id FROM account WHERE user_id = 1002), 150.00);

INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount)
VALUES
(2, 2, (SELECT account_id FROM account WHERE user_id = 1001), (SELECT account_id FROM account WHERE user_id = 1003), 200.00);

INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount)
VALUES
(1, 1, (SELECT account_id FROM account WHERE user_id = 1002), (SELECT account_id FROM account WHERE user_id = 1001), 50.00);

INSERT INTO transfer (transfer_type_id, transfer_status_id, account_from, account_to, amount)
VALUES
(1, 3, (SELECT account_id FROM account WHERE user_id = 1003), (SELECT account_id FROM account WHERE user_id = 1001), 75.00);
